...
const ClockWidget = () => {
  ...
  return (
    <div className="bento-card-hover animate-fade-up flex flex-col items-center justify-center text-center py-4" style={{ animationDelay: "400ms" }} data-journey-clock>
